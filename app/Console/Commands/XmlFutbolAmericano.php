...
class XmlFutbolAmericano extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'xml:futbolAmericano';
    ...
    public function handle()
    {
        ...
        foreach ($rutas as $index => $ruta) {
            try {
                ...
                Log::info('Los logros no pudieron actualizarse.');
            }
        }
        Log::info('Los logros de fútbol americano se han actualizado correctamente.');
    }
}