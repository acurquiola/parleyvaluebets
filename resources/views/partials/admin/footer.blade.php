		...
		<script src=" {{ asset('/assets/plugins/datatables.net-buttons-bs/js/buttons.bootstrap.min.js') }}" type="text/javascript"></script>  
		...
		<script src=" {{ asset('/assets/plugins/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js') }}" type="text/javascript"></script>  
		...
		<script src=" {{ asset('/assets/plugins/datatables.net-responsive-bs/js/responsive.bootstrap.js') }}" type="text/javascript"></script>  
		<script src=" {{ asset('/assets/plugins/datatables.net-scroller/js/datatables.scroller.min.js') }}" type="text/javascript"></script>  
