...
<div class="right_col" role="main">
	<div class="">
		...
		<ol class="breadcrumb">
			...
			<li><a class="active">Establecer Contraseña</a></li>
		</ol>
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
	                    	{!! Form::model($user, ["url" => action('UserController@postEstablecerContraseña'), "method" => "POST", 'data-parsley-validate',  'class'=>"form-horizontal form-label-left"]) !!}
